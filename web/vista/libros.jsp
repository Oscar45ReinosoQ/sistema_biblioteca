                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item active">
                            <a href="principal.jsp" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-home-circle titulo"></i>
                                                ...
                                                <div class="modal-body m-0">
                                                    <form method="get" action="login_btn">
                                                        <div class="row g-xxl-5">                                                                            
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class=" text-primary form-label">Año publicacion:</label>
                                                                <input type="text" class="form-control" required name="proNombres-add-a">
                                                            </div> 
                                                            <div class="col-md-6">
                                                                <label class=" text-primary form-label">Ediccion:</label>
                                                                <input type="text" class="form-control" required name="proNombres-add-a">
                                                            </div>
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class=" text-primary form-label">Editorial:</label>
                                                                <input type="text" class="form-control" required name="proNombres-add-a">
                                                            </div> 
                                                            <div class="col-md-6">
                                                                <label class=" text-primary form-label">ISBM:</label>
                                                                <input type="text" class="form-control" required name="proNombres-add-a">
                                                            </div> 
                                                             <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select class="default-select form-control wide mb-3" name="proJefeHogar-add-a" required>                                                                                             
                                                                    <option value="1">Fisicos</option>
                                                                    <option value="0">Digitales</option>
                                                                </select>
                                                            </div>   
                                                            <div class="col-md-6">
                                                                <label class="form-label text-primary">Stock:</label>
                                                                <input type="text" class="form-control" name="proHijosNumero-add-a" required>
                                                            </div> 
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">CD:</label>
                                                                 <select class="default-select form-control wide mb-3" name="proJefeHogar-add-a" required>                                                                                             
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Vigencia del recurso:</label>
                                                                <input type="date" class="form-control" name="proAnioIncCultivo-add-a" required>
                                                            </div> 
                                                        </div>                                                                        
                                                    </form>
                                                </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example3" class="display table header-border table-hover verticle-middle" style="min-width: 1200px">
                                            <thead>
                                                <tr>
                                                    <th class="text-primary text-center">ID</th>
                                                    <th class="text-primary text-center">Codigo</th>
                                                    <th class="text-primary text-center">Año publicacion</th>
                                                    <th class="text-primary text-center">Ediccion</th>
                                                    <th class="text-primary text-center">Titulo</th>
                                                    <th class="text-primary text-center">Autor</th>
                                                    <th class="text-primary text-center">Editorial</th>
                                                    <th class="text-primary text-center">ISBM</th>                                                    
                                                    <th class="text-primary text-center">N° Paginas</th>
                                                    <th class="text-primary text-center">Tipo</th>
                                                    <th class="text-primary text-center">Stock</th>
                                                    <th class="text-primary text-center">CD</th>
                                                    <th class="text-primary text-center">Vigencia del recurso</th>
                                                    <th class="text-primary text-center">Tipo</th>
