<%-- 
    Document   : index
    Created on : 15 ago. 2022, 13:18:04
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#">
                                                <span class="d-flex align-items-center align-middle">
                                                    ...
                                                    <span class="flex-grow-1 align-middle">Cartera</span>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body m-0">
                                                    <form method="get" action="login_btn">
                                                        <div class="row g-xxl-5">                                                                            

                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Fecha salida prestamo:</label>
                                                                <input type="date" class="form-control" name="proFechaNacimiento-add-a" required>                                                               
                                                            </div>   
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Hora de salida de prestamo:</label>
                                                                <input type="time" class="form-control" name="proFechaNacimiento-add-a" required>                                                               
                                                            </div> 
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Fecha devolucion prestamo:</label>
                                                                <input type="date" class="form-control" name="proFechaNacimiento-add-a" required>                                                               
                                                            </div> 
                                                            <div class="col-md-6">
                                                                <label class="form-label text-primary">Hora devolucion prestamo:</label>
                                                                <input type="time" class="form-control" name="proHijosNumero-add-a" required>
                                                            </div> 
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Nombre del autor:</label>
                                                                <input type="text" class="form-control" name="proCedula-add-a" required>                                            
                                                            </div>   
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Apellido del autor:</label>
                                                                <input type="text" class="form-control" name="proCedula-add-a" required>                                            
                                                            </div>   
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Cuidad del autor:</label>
                                                                <input type="text" class="form-control" name="proCedula-add-a" required>                                            
                                                            </div>   
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Pais del autor:</label>
                                                                <input type="text" class="form-control" name="proCedula-add-a" required>                                            
                                                            </div>   
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Carrera del estudiante:</label>
                                                                <select class="default-select form-control wide mb-3" name="proJefeHogar-add-a" required>                                                                                             
                                                                    <option value="0">DESAROLLO DE SOFTWARE</option>
                                                                    <option value="0">ADMINISTRACION DE EMPRESAS</option>
                                                                    <option value="0">DISEÑO GRAFICO</option>
                                                                </select>                                       
                                                            </div>   
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Nivel del estudiante:</label>
                                                                <select class="default-select form-control wide mb-3" name="proJefeHogar-add-a" required>                                                                                             
                                                                    <option value="0">PRIMERO</option>
                                                                    <option value="0">SEGUNDO</option>
                                                                    <option value="0">TERCERO</option>
                                                                    <option value="0">CUARTO</option>
                                                                    <option value="0">QUINTO</option>
                                                                    <option value="0">SEXTO</option>
                                                                </select>                                             
                                                            </div>   
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Paralelo del estudiante:</label>
                                                                <select class="default-select form-control wide mb-3" name="proJefeHogar-add-a" required>                                                                                             
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class="text-primary form-label">Estado del prestamo:</label>
                                                                <input type="text" class="form-control" name="proCedula-add-a" required>                                            
                                                            </div>
                                                        </div>
                                                    </form>
                                    ...
                                    <table id="example3" class="display table header-border table-hover verticle-middle" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-primary text-center">Fecha salida prestamo</th>
                                                <th class="text-primary text-center">Hora salida prestamo</th>
                                                <th class="text-primary text-center">Fecha devolucion prestamo</th>
                                                <th class="text-primary text-center">Hora devolucion prestamo</th>
                                                <th class="text-primary text-center">Estado prestamo</th>
                                                <th class="text-primary text-center">Nombre autor</th>
                                                <th class="text-primary text-center">Apellido autor</th>
                                                <th class="text-primary text-center">Cuidad autor</th>
                                                <th class="text-primary text-center">Pais autor</th>
                                                <th class="text-primary text-center">Carrera Estudiante</th>
                                                <th class="text-primary text-center">Nivel Estudiante</th>
                                                <th class="text-primary text-center">Paralelo Estudiante</th>
